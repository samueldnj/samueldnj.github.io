...
abstract_short = "Hierarchical multi-stock stock assessment models are becoming a more popular method for sharing information between data-rich and data-poor stocks. We simulation test the estimation performance of single stock and hierarchical multi-stock versions of a state-space surplus production model under data-rich and data-poor scenarios, fitting the best performing models to data from the British Columbia complex of Dover Sole. Multi-stock models that estimated hierarchical priors for survey catchability performed the best under data-poor scenarios. We conclude that hierarchical multi-stock assessment models are useful for data-limited stocks and could provide a more flexible alternative to data-pooling and catch only methods"
